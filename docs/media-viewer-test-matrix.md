...
| MV-08b | Local GEDCOM | `FILE mv-08b-local-test.ged`, `FORM ged` | Scrollable plain-text preview                    | - |                     |
...
- TXT/Markdown/GEDCOM/RTF previews show readable text without PHP errors.
